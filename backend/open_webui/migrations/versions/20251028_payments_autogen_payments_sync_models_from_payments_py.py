"""payments: sync models from payments.py

Revision ID: 20251028_payments_autogen
Revises: a5c220713937
Create Date: 2025-10-28 14:07:26.957827
...
revision: str = '20251028_payments_autogen'
...
def upgrade() -> None:
    ...
    op.alter_column('chat', 'updated_at',
               existing_type=sa.BIGINT(),
               nullable=True)
    # op.alter_column('chat', 'share_id_old',
    #            existing_type=sa.VARCHAR(length=255),
    #            type_=sa.Text(),
