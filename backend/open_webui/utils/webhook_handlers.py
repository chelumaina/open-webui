...
PAYPAL_CLIENT_ID = (
    "AV7CoRHni5FA0I-RQkQRcjGbmR6fiE2sxbOV9iivnm7Sn03UG5gufJceXBGj08qI4-N3cDE17i6bSR48"
)
PAYPAL_CLIENT_SECRET = (
    "EI2HsBHaJvG5rKAsoAMdfA1pSKms7J5gNOIk8TZC1VS8FBDAzsAg0-K0Lk4Waw996AFjThfHQV-0wnb5"
)
...
async def capture_paypal_order(order_id: str):
    ...
    async with httpx.AsyncClient() as client:
        response = await client.post(
            f"{PAYPAL_BASE_URL}/v2/checkout/orders/{order_id}/capture", headers=headers
        )
...
async def create_paypal_order(
    user_id: str, amount: float = "10.00", currency: str = "USD"
):
    ...
    async with httpx.AsyncClient() as client:
        response = await client.post(
            f"{PAYPAL_BASE_URL}/v2/checkout/orders", headers=headers, json=order_data
        )
