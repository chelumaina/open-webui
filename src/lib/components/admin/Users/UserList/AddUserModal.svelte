					...
					<div class="px-1">
						{#if tab === ''}
							...
							<div class="flex flex-col w-full mt-1">
								...
								<div class="flex-1">
									<input
										class="w-full text-sm bg-transparent disabled:text-gray-500 dark:disabled:text-gray-500 outline-hidden border border-gray-300 dark:border-white p-1 rounded"
										type="text"
