<script>
	// import { useIntersection, handleImpression } from './../../lib/utils/index.ts';
	...
	onMount(async () => {
		// alert('Please use the new version of the app. This version is deprecated and will be removed in the future.');


		// const currentPage = get(page);
    	// const { url, params } = currentPage;
		...
		// 	let x= await fetch('/api/track-impression', {
		// 	method: 'GET', 
 				...
 				<div class="w-full sm:max-w-md px-10 min-h-screen flex flex-col text-center">
					...
					{:else}
						<div class="  my-auto pb-10 w-full dark:text-gray-100">
							<ImpressionTracker sectionId="signup-section">
							...
							{#if Object.keys($config?.oauth?.providers ?? {}).length > 0}
								...
								<div class="flex flex-col space-y-2">
									...
									<ImpressionTracker sectionId="google-section">
										<button
											class="flex justify-center items-center bg-gray-700/5 hover:bg-gray-700/10 dark:bg-gray-100/5 dark:hover:bg-gray-100/10 dark:text-gray-300 dark:hover:text-white transition w-full rounded-full font-medium text-sm py-2.5 border border-gray-300 dark:border-gray-600"
											on:click={() => {
												window.location.href = `${WEBUI_BASE_URL}/auth/google/login`;
											}}
										>
									...
									<ImpressionTracker sectionId="github-section">
										<button
											class="flex justify-center items-center bg-gray-700/5 hover:bg-gray-700/10 dark:bg-gray-100/5 dark:hover:bg-gray-100/10 dark:text-gray-300 dark:hover:text-white transition w-full rounded-full font-medium text-sm py-2.5 border border-gray-300 dark:border-gray-600"
											on:click={() => {
									...
									{#if $config?.oauth?.providers?.oidc}
										<ImpressionTracker sectionId="oidc-section">
											<button
												class="flex justify-center items-center bg-gray-700/5 hover:bg-gray-700/10 dark:bg-gray-100/5 dark:hover:bg-gray-100/10 dark:text-gray-300 dark:hover:text-white transition w-full rounded-full font-medium text-sm py-2.5 border border-gray-300 dark:border-gray-600"
												on:click={() => {
